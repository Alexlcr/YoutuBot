...
const Avicii = require ('./Commande/Avicii')
...
bot.on('ready', function (){
    ...
    bot.user.setGame('Rechercher les dernières vidéos de Youtube | /help')
})
...
bot.on('message', function(message){
 ...
 if (message.content === '/helpCommunauté'){
    ...
    var embed = new Discord.RichEmbed()
    .setColor("#c11111")
    .addField("**Les commandes concernant les communauté sont: **","Pour rejoindre une communauté faites ---> /NomDuYoutubeur \nPour quitter une communauté faites ---> //NomDuYoutubeur \n**Les Youtubeurs disponibles sont: **\n-Squeezie\n-Amixem\n-FantaBobGames\n-TiboInShape\n-Joyca\n-Mastu\n-LinkTheSun\n-SuperConeri\n-Maskey\n-MahdiBa\n-Farod\n-JorianPonomareff\n-Potatoz\n-Vodkprod\n-WankilStudio\n-Norman\n-LeRireJaune\n-DrNozman\n-GearLocker\n-JoueurDuGrenier\n-Mamytwink\n-Cyprien\n-100%Bitume\n-FabienOlicard\n-CYR!L\n-Bapt&Gael\n")
    message.channel.send(embed)
    .catch(console.error)
 }
