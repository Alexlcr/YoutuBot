...
module.exports = class Role extends Command {
	...
	static action(message) {
		...
		.catch(console.error)}else if (message.content.startsWith('/FantaBobGames')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/VodKprod')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/Amixem')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/TiboInShape')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/Joyca')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/Mastu')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/LeRireJaune')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/DrNozman')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/GearLocker')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/JoueurDuGrenier')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/Mamytwink')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/Cyprien')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/100%Bitume')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/FabienOlicard')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/CYR!L')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/Bapt&Gael')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/Cokaïn.fr')) {
		...
		.catch(console.error)}else if (message.content.startsWith('/Norman')){
		...
		.catch(console.error)}else if (message.content.startsWith('/WankilStudio')){
			message.member.addRole(message.member.guild.roles.find('name','Communauté Norman Fait Des Vidéos'))
		...
		.catch(console.error)}else if (message.content.startsWith('/LinkTheSun')){
		...
		.catch(console.error)}else if (message.content.startsWith('/Potatoz')){
		...
		.catch(console.error)}else if (message.content.startsWith('/JorianPonomareff')){
		...
		.catch(console.error)}else if (message.content.startsWith('/Farod')){
		...
		.catch(console.error)}else if (message.content.startsWith('/MahdiBa')){
		...
		.catch(console.error)}else if (message.content.startsWith('/Maskey')){
		...
		.catch(console.error)}else if (message.content.startsWith('/SuperConeri')){
		...
		.catch(console.error)}else if (message.content.startsWith('//Squeezie')) {
		...
		.catch(console.error)}else if (message.content.startsWith('//BobLennon')){

			message.member.remove(message.member.guild.roles.find('name', 'Communauté FantBobGames'));
			message.reply('Vous avez quitté cette communauté')
			.catch(console.error)
		
		.catch(console.error)}else if (message.content.startsWith('//VodK')){

			message.content.removeRole(message.member.guild.roles.find('name', 'Communauté VodK'))
			message.reply('Vous avez quitté cette communauté')
			.catch(console.error)
		
		.catch(console.error)}else if (message.content.startsWith('//Cypiren')){
		...
		.catch(console.error)}else if (message.content.startsWith('//LinksTheSun')){
